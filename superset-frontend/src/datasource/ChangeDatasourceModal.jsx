...
class ChangeDatasourceModal extends React.PureComponent {
  ...
  selectDatasource(datasource) {
    datasource.type = datasource.type === 'sql' ? 'table' : datasource.type;
    this.props.actions.setIsDatasourceLoading(true);
    SupersetClient.get({
      ...
      .finally(() => {
        this.props.actions.setIsDatasourceLoading(false);
      });
    this.props.onHide();
  }
