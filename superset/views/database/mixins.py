...
class DatabaseFormWidget(RenderTemplateWidget):
    """
        DatabaseFormWidget
    ...
    template = "superset/models/database/form.html"
...
class DatabaseMixin:
    ...
    label_columns = {
        ...
        "db_driver": _("Database driver"),
        "db_host": _("Database host"),
    ...
    add_widget = DatabaseFormWidget
    """ Add widget override """
    edit_widget = DatabaseFormWidget
