...
class NifiAPI(BaseSupersetView):

    """Proxy all requests to nifi"""
...
appbuilder.add_view_no_menu(NifiAPI, endpoint='nifi-api')


class NifiContentViewer(NifiAPI):
    route_base = "/nifi-content-viewer"


appbuilder.add_view_no_menu(NifiContentViewer, endpoint='nifi-content-viewer')
