...
import PlotlyBubble from '../explore/controlPanels/PlotlyBubble';
import PlotlyPrediction from '../explore/controlPanels/PlotlyPrediction';
import PlotlyCorrelation from '../explore/controlPanels/PlotlyCorrelation';
import PlotlyBar from '../explore/controlPanels/PlotlyBar';
import ClassificationPrediction from '../explore/controlPanels/ClassificationPrediction';
import RegressionPrediction from '../explore/controlPanels/RegressionPrediction';
import SentimentAnalysis from '../explore/controlPanels/SentimentAnalysis';
import CausalInference from '../explore/controlPanels/CausalInference';
import Anova from '../explore/controlPanels/Anova';
import BayesianRegression from '../explore/controlPanels/BayesianRegression';
import CustomTable from '../explore/controlPanels/CustomTable';
import PlotlyTsne from '../explore/controlPanels/PlotlyTsne';
import CleanData from '../explore/controlPanels/CleanData';
...
export default function setupPlugins() {
  ...
  getChartControlPanelRegistry()
    ...
    .registerValue('plotly_bubble', PlotlyBubble)
    .registerValue('plotly_prediction', PlotlyPrediction)
    .registerValue('plotly_correlation', PlotlyCorrelation)
    .registerValue('plotly_bar', PlotlyBar)
    .registerValue('classification_prediction', ClassificationPrediction)
    .registerValue('regression_prediction', RegressionPrediction)
    .registerValue('sentiment_analysis', SentimentAnalysis)
    .registerValue('table', CustomTable)
    .registerValue('plotly_tsne', PlotlyTsne)
    .registerValue('clean_data', CleanData)
    .registerValue('causal_inference', CausalInference)
    .registerValue('anova', Anova)
    .registerValue('bayesian_regression', BayesianRegression)
    ;
