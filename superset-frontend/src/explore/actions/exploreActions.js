...
export const SET_DATASOURCE_LOADING = 'SET_DATASOURCE_LOADING';
export function setIsDatasourceLoading(isDatasourceLoading) {
  return { type: SET_DATASOURCE_LOADING, isDatasourceLoading };
}
...
export function updateFormData(form_data){
  return { type: UPDATE_FORM_DATA, form_data}
}