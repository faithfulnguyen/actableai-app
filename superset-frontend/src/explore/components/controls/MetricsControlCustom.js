...
export default class MetricsControlCustom extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    onChange(opts) {
        ...
        if (opts.length > 0 || controlValue.length > 0) {
            if (this.props.order_by.type === 'SelectControl') {
                this.props.actions.setControlValue('order_by', [], []);
            }
        }

        if (opts.length === 0 && controlValue.length === 0) {
            if (this.props.dictint.value === false) {
                this.props.actions.setControlValue('order_by', [], []);
            }
        }
...
MetricsControlCustom.propTypes = propTypes;
MetricsControlCustom.defaultProps = defaultProps;
