...
# Default database for upload appsheet data. Please make sure that we already had that record in our table DBS.
APPSHEET_TEMP_UPLOAD_CSV_DB = "actableai"
APPSHEET_TEMP_UPLOAD_CSV_SCHEMA = "public"
# Default database for create user workspace schema. Please make sure that we already had that record in our table DBS.
...
DEBUG = os.environ.get("SUPERSET_ENV") == "development"
...
# COnfigfor ray
RAY_CLIENT = os.getenv("RAY_CLIENT")
RAY_ADDRESS = os.getenv("RAY_ADDRESS")
RAY_PASSWORD = os.getenv("RAY_PASSWORD")
RAY_MAX_CONCURRENT = os.getenv("RAY_MAX_CONCURRENT")
RAY_CPU_PER_TRIAL = os.getenv("RAY_CPU_PER_TRIAL")
RAY_GPU_PER_TRIAL = os.getenv("RAY_GPU_PER_TRIAL")

N_CPU_CLASSIFICATION=os.getenv("N_CPU_CLASSIFICATION")
N_GPU_CLASSIFICATION=os.getenv("N_GPU_CLASSIFICATION")

N_CPU_REGRESSION=os.getenv("N_CPU_REGRESSION")
N_GPU_REGRESSION=os.getenv("N_GPU_REGRESSION")

N_CPU_CAUSAL_INFERENCE=os.getenv("N_CPU_CAUSAL_INFERENCE")
N_GPU_CAUSAL_INFERENCE=os.getenv("N_GPU_CAUSAL_INFERENCE")

N_CPU_TIMESERIES=os.getenv("N_CPU_TIMESERIES")
N_GPU_TIMESERIES=os.getenv("N_GPU_TIMESERIES")

N_CPU_SEGMENTATION=os.getenv("N_CPU_SEGMENTATION")
N_GPU_SEGMENTATION=os.getenv("N_GPU_SEGMENTATION")

N_CPU_IMPUTATION=os.getenv("N_CPU_IMPUTATION")
N_GPU_IMPUTATION=os.getenv("N_GPU_IMPUTATION")

N_CPU_CORRELATION=os.getenv("N_CPU_CORRELATION")
N_GPU_CORRELATION=os.getenv("N_GPU_CORRELATION")

N_CPU_BAYESIAN_REGRESSION=os.getenv("N_CPU_BAYESIAN_REGRESSION")
N_GPU_BAYESIAN_REGRESSION=os.getenv("N_GPU_BAYESIAN_REGRESSION")

# Configure flag for features
SAP_FEATURE = 'false'
LINKEDIN_FEATURE = 'true'
BILLING_FEATURE = os.environ["BILLING_FEATURE_ENABLED"]
BILLING_TRIAL_FEATURE = os.environ["BILLING_TRIAL_ENABLED"]
BILLING_TRIAL_DAY = 14
DASHBOARD_FEATURE = 'true'
USECASES_FEATURE = 'true'
# Configure flag analysis
DATACLEAN_ANALYTICS_FEATURE = 'true'
CLASSIFICATION_ANALYTICS_FEATURE = 'true'
REGRESSION_ANALYTICS_FEATURE = 'true'
SUNBURST_CHART_FEATURE = 'false'
SANKEY_DIAGRAM_FEATURE = 'false'
NIGHTINGALE_ROSE_CHART_FEATURE = 'false'
PARTITION_CHART_FEATURE = 'false'
FORCE_DIRECTED_GRAPH_FEATURE = 'false'
CHORD_DIAGRAM_FEATURE = 'false'
...
# Whitelist access from google sheet
API_KEY_WHITELIST = [os.getenv("SECRET_API_KEY")]

# These are the paths for storing data regarding mindsdb models and model info
MINDSDB_STORAGE_PATH = "/tmp/mindsdb_storage"
...
BILLING_ANALYTICS_CHECK_PAYMENT = [
    ...
    "plotly_correlation", 'causal_inference', 'bayesian_regression']
...
# Config for resources predictors
AWS_S3_RESOURCES_PREDICTORS_BUCKET = os.getenv("AWS_S3_RESOURCES_PREDICTORS_BUCKET")
AWS_S3_RESOURCES_PREDICTORS_PREFIX = os.getenv("AWS_S3_RESOURCES_PREDICTORS_PREFIX")
RESOURCES_PREDICTORS_BACKUP_PROBABILITY = os.getenv("RESOURCES_PREDICTORS_BACKUP_PROBABILITY")
MEMORY_OPTIMIZER_OFFSET = os.getenv("MEMORY_OPTIMIZER_OFFSET")
MEMORY_OPTIMIZER_NRMSE_THRESHOLD = os.getenv("MEMORY_OPTIMIZER_NRMSE_THRESHOLD")
FLASK_MONITORING_DASHBOARD_ENABLE = os.getenv("FLASK_MONITORING_DASHBOARD_ENABLE")

# Config sentry
SENTRY_ENABLE=os.getenv("SENTRY_ENABLE")
SENTRY_RELEASE=os.getenv("SENTRY_RELEASE") 
SENTRY_JS_DSN=os.getenv("SENTRY_JS_DSN")
SENTRY_FLASK_DSN=os.getenv("SENTRY_FLASK_DSN")
#Set traces_sample_rate to 1.0 to capture 100%
# of transactions for performance monitoring.
# We recommend adjusting this value lower than 1.0 in production.
SENTRY_TRACES_SAMPLE_RATE=0.5 
ALLOW_VIEW_ANOTHER_PROFILE = False
ALLOW_GUEST_VIEW_PUBLIC_DATA = True
