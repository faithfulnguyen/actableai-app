...
class DatasourceControl extends React.PureComponent {
  ...
  render() {
    ...
    const { datasource, onChange, onDatasourceSave, value, actions } = this.props;
    return (
      <div>
          ...
          >
            ...
            >
              ...
              {datasource.type === 'table' &&
                datasource.sql &&
                !!datasource.saved_query_id && (
                  <MenuItem
                    eventKey="3"
                    href={`/superset/sqllab?savedQueryId=${datasource.saved_query_id}`}
                    target="_blank"
