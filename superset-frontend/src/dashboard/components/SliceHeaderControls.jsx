      ...
      >
        ...
        <Dropdown.Menu>
          ...
          {this.props.supersetCanExplore && (
            <MenuItem onClick={this.exploreChart}>{t('Edit chart')}</MenuItem>
          )}
          {this.props.slice.form_data.sql && (
            <MenuItem
              href={`/superset/sqllab?savedQueryId=${this.props.slice.form_data.saved_query_id}`}
              target="_blank"
            >
              {t('Edit SQL')}
            </MenuItem>
