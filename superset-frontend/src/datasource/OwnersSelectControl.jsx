...
import Select from './OwnersSelect';
...
const OwnersSelectControl = props => {
  const {
    value,
    onChange,
    dataEndpoint,
...
OwnersSelectControl.propTypes = propTypes;
OwnersSelectControl.defaultProps = defaultProps;

export default withToasts(OwnersSelectControl);
