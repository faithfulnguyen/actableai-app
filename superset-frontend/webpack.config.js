...
const config = {
  ...
  entry: {
    ...
    sap: addPreamble('/src/sap/index.jsx'),
    linkedin: addPreamble('/src/linkedin/index.jsx'),
    showSavedQuery: [path.join(APP_DIR, '/src/showSavedQuery/index.jsx')],
    prediction: addPreamble('/src/prediction/index.jsx'),
    mapping: addPreamble('/src/mapping/index.jsx'),
    dialogflow: addPreamble('/src/dialogflowClient/index.jsx'),
    archiveOrganization: addPreamble('/src/archiveOrganization/index.jsx'),
    billing: addPreamble('/src/billing/index.jsx'),
    addTable: addPreamble('/src/addTable/index.jsx'),
    walkthrough: addPreamble('/src/walkthrough/index.jsx'),
    analysis: addPreamble('/src/addAnalysis/index.jsx'),
    content: addPreamble('/src/addContent/index.jsx'),
    menuUseCases: addPreamble('/src/addMenu/index.jsx'),
    authProvider: addPreamble('/src/authProvider/index.jsx'),
  },
  output,
  stats: 'minimal',
  performance: {
  ...
  optimization: {
    splitChunks: {
      ...
      cacheGroups: {
        ...
        major: {
          name: 'vendors-major',
          test: /\/node_modules\/(brace|react|react-dom|@superset-ui\/translation|webpack.*|@babel.*|styled-components)\//,
        },
      },
    },
  },
