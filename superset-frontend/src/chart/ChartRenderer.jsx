...
import PlotlyChart from "src/chart/Plotly/PlotlyChart";
...
class ChartRenderer extends React.Component {
  ...
  shouldComponentUpdate(nextProps) {
    ...
    if (resultsReady) {
      ...
      // get taskId
      const nextTaskId = nextProps.chart === undefined ? nextProps.taskId : nextProps.chart.taskId;
      const taskId = this.props.chart === undefined ? this.props.taskId : this.props.chart.taskId;
  ...
  render() {
    ...
    return (
        <React.Fragment>
          {
            vizType.includes('plotly_') || vizType.includes('_prediction') 
              || vizType === 'table' 
              || vizType === 'clean_data' 
              || vizType === 'sentiment_analysis'
              || vizType === 'causal_inference'
              || vizType === 'anova'
              || vizType === 'bayesian_regression' ? (
                <PlotlyChart {...this.props} />
            ) : (
                <SuperChart
