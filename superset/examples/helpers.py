...
def get_path_by_filename(filename):
    filepath = "{}/v2/data/{}.csv".format(EXAMPLES_FOLDER, filename)
    return filepath

def get_path_by_filename_of_billing(filename):
    filepath = "{}/billings/data/{}.csv".format(EXAMPLES_FOLDER, filename)
    return filepath
