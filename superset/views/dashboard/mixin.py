...
class DashboardMixin:  # pylint: disable=too-few-public-methods
    ...
    list_columns = ["dashboard_link", "creator", "published", "is_public", "modified"]
    order_columns = ["dashboard_link", "modified", "published", "is_public"]
    edit_columns = [
        "dashboard_title",
        "slug",
        "owners",
    ...
    description_columns = {
        ...
        "is_public": _(
            "Determines whether or not this dashboard is accessed by anonymous."
        ),
    }
