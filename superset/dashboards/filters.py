        ...
        if security_manager.is_beta_user():
            query = query.filter(
                or_(
                    ...
                    Dashboard.created_by_fk == security_manager.user_model.get_user_id(),
                    Dashboard.is_example == True
                )
            )
            return query
            ...
            all_datasource_access = security_manager.can_access_all_datasources()
