...
from ..core.serde import dump_json, fqname_for, load_json
from ..dataset import Dataset, DataEntry, InferenceDataLoader
...
class Predictor(ABC):
    ...
    def __init__(self, prediction_length: int, freq: str, lead_time: int=0) -> None:
    ...
    def serialize(self, path: Path) -> None:
        ...
        with (path / "version.json").open("w") as fp:
            json.dump(
                {"model": self.__version__, "pts": __version__}, fp
            )
