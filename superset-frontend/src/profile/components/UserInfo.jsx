  ...
  <div>
    ...
    <Panel>
      <Panel.Body>
        ...
        {user.apiKey && user.apiKey.length > 0 && (
          <p>
            <i className="fa fa-comments" />
            &nbsp;
            <span className="text-muted">{t('CHAT API KEY: ')}</span>&nbsp;
            <span className="user-id">{user.apiKey}</span>
          </p>
        )}
        <hr />
        <ul className="nav nav-pills nav-stacked">
          <li>
            <a href="/userinfoeditview/form">
              <i className="fa fa-edit" />
              <span>Edit User </span>
            </a>
          </li>
          <li>
            <a href="/resetmypassword/form">
