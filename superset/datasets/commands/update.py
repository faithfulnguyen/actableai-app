...
class UpdateDatasetCommand(BaseCommand):
    ...
    def validate(self) -> None:
        ...
        if not DatasetDAO.validate_update_uniqueness(
            self._model.database_id, self._model_id, table_name, schema
        ):
            table = DatasetDAO.get_table(database_id, table_name, schema)
            exceptions.append(DatasetExistsValidationError(table.id, table_name))
